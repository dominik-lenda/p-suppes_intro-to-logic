...
\singlespace
\begin{enumerate}[label=(\alph*)]
\item \(P \land Q\) is \textbf{not} a tautology.\\
\(
\begin{array}{|c c|c|c|}
P & Q & P \land Q & (P_1 \lor -P_2) \land (Q_1 \lor -Q_2)\\
\hline
T & T & T & T\\
T & F & F & T\\
F & T & F & T\\
...
\end{array}
\)\\
Changing atomic sentences \(P\) and \(Q\) into compound sentences \(P_1 \lor -P_2\) and \(Q_1 \lor -Q_2\) makes the whole sentence tautology.
\end{enumerate}
